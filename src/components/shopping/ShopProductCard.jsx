            ...
            <div className="w-full ml-4 grid grid-cols-[1fr_30px] grid-rows-2 gap-3 justify-items-center content-center">
                <div className="flex items-center justify-center">
                    ...
                    <div className="ml-4 flex items-center border-gray-100">
                        <button className="cursor-pointer rounded-l bg-gray-200 py-2 px-4 duration-100 hover:bg-blue-500 hover:text-blue-50"> - </button>
                        <input className="h-10 w-10 border bg-white text-center text-xs outline-none" type="number" value="0" min="1" />
                        <button className="cursor-pointer rounded-r bg-gray-200 py-2 px-4 duration-100 hover:bg-blue-500 hover:text-blue-50"> + </button>
                    </div>
                </div>
